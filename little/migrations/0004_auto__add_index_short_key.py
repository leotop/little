...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Short', fields ['key']
        db.create_index(u'little_short', ['key'])


    def backwards(self, orm):
        # Removing index on 'Short', fields ['key']
        db.delete_index(u'little_short', ['key'])
    ...
    models = {
        ...
        u'little.short': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'little.visit': {
            'Meta': {'ordering': "('-created_at',)", 'object_name': 'Visit'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
